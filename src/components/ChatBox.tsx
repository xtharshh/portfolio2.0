    ...
    <div className="fixed bottom-14 right-10 z-50">
      {!isOpen ? (
        ...
        <Button
          ...
          size="default"
          className="rounded-full p-6 bg-gray-300 text-black hover:bg-gray-500 dark:bg-[#ff4d8d] dark:text-white dark:hover:bg-[#ff3a7d] shadow-lg transition-colors"
        >
          
          <Bot className="h-12 w-12" />
        <h1 className="sr-only">Kool.Ai</h1>
        </Button>
        
        </div>
      ) : (
        <Card className="w-[380px] h-[550px] bg-white dark:bg-[#1a1625] shadow-2xl border border-gray-200 dark:border-[#2a2438] transition-colors">
          <CardHeader className="flex  justify-between bg-gradient-to-r from-[#ff4d8d] via-[#b666d2] to-[#40c9ff] text-white p-4 rounded-t-lg">
            ...
            <Button
              ...
              className="text-white hover:bg-gray-800 dark:hover:bg-[#3a3448] rounded-full ml-28 transition-colors"
          ...
          <CardContent className="p-4 h-[420px] bg-gray-50 dark:bg-[#1a1625]">
